...
def create_ardis_poisoned_dataset(emnist_dataset, fraction=1, num_gdps_sampled=100):
    ...
    ardis_images=np.loadtxt('./attack_of_the_tails/ARDIS_train_2828.csv', dtype='float')
    ardis_labels=np.loadtxt('./attack_of_the_tails/ARDIS_train_labels.csv', dtype='float')
...
def create_ardis_test_dataset(emnist_dataset):
    ...
    # load the data from csv's
    ardis_images=np.loadtxt('attack_of_the_tails/ARDIS_test_2828.csv', dtype='float')
    ardis_labels=np.loadtxt('attack_of_the_tails/ARDIS_test_labels.csv', dtype='float')
...
if __name__ == '__main__':
    ...
    with open("./attack_of_the_tails/poisoned_dataset_fraction_{}".format(fraction), "wb") as saved_data_file:
        torch.save(poisoned_emnist_dataset, saved_data_file)


    ardis_test_dataset = create_ardis_test_dataset(emnist_train_dataset)

    with open("./attack_of_the_tails/ardis_test_dataset.pt", "wb") as ardis_data_file:
